...
export type NumberField<State extends FieldState = DefaultFieldState> = FieldWithModifiers<
...
function makeNumberField<State extends FieldState>(
  ...
  return withFieldModifiers({
    ...
    rebuild: <NextState extends FieldState>(nextState: NextState) =>
      makeNumberField(options, nextState) as WithFieldState<NumberFieldCore<State>, NextState>,
  })
}
