...
export const createManagerOperationContracts = () =>
  ({
    ...
    "manager.auth.ipBlocks.list": defineOperationContract({
      access: "auth",
      kind: "query",
      description: "List persistently blocked password-login IP addresses",
      output: listPasswordIpBlocksOutput,
      method: "get",
    }),
    "manager.auth.ipBlocks.unblock": defineOperationContract({
      access: "auth",
      kind: "mutation",
      description: "Remove a persistent password-login IP block",
      input: unblockPasswordIpInput,
      output: unblockPasswordIpOutput,
      method: "post",
    }),
