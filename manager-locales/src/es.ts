...
export const esManagerMessages: ManagerLocalePack['messages'] = {
  ...
  'contentEdit.saveAsDraft': 'Guardar copia como borrador',
  'contentEdit.saveAsVariant': 'Guardar copia como variante',
  'contentEdit.saveOptions': 'Opciones de guardado',
  'contentEdit.discardChanges': 'Descartar cambios',
  'contentEdit.discardChangesTitle': '¿Descartar los cambios sin guardar?',
  'contentEdit.discardChangesDescription':
    'Se restaurará la última versión guardada de este elemento. Se perderán los cambios compartidos sin guardar de todos los editores.',
  'contentEdit.discardChangesWithTemplateDescription':
    'Se restaurará la última versión guardada de este elemento y de su template compartido. Se perderán los cambios compartidos sin guardar de todos los editores.',
  ...
  'contentEdit.changesDiscarded': 'Cambios descartados',
  ...
  'contentEdit.couldNotDiscardChanges': 'No se pudieron descartar los cambios',
