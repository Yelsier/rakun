...
export const esManagerMessages = {
  ...
  'settings.seo': 'SEO',
  'contentTypes.category.layout': 'Layout',
  'contentTypes.category.blocks': 'Bloques',
  'contentTypes.category.dynamicData': 'Datos dinámicos',
  'contentTypes.category.editorial': 'Editorial',
  'contentTypes.category.development': 'Desarrollo',
  'contentTypes.category.content': 'Contenido',
  'contentTypes.header.menu': 'Headers',
  'contentTypes.footer.menu': 'Footers',
  'contentTypes.pageSection.menu': 'Secciones de página',
  'contentTypes.category.menu': 'Categorías',
  'contentTypes.project.menu': 'Proyectos',
  'contentTypes.featureCarousel.menu': 'Carruseles destacados',
  'contentTypes.categoriesGallery.menu': 'Galerías de categorías',
  'contentTypes.page.menu': 'Páginas',
  'contentTypes.author.menu': 'Autores',
  'contentTypes.article.menu': 'Artículos',
  'contentTypes.relationLevel2.menu': 'Relaciones nivel 2',
  'contentTypes.relationPlayground.menu': 'Playground de relaciones',
  'contentTypes.imagePlayground.menu': 'Playground de imágenes',
  'contentTypes.conditionalDemo.menu': 'Demos condicionales',
  'contentTypes.translationPlayground.menu': 'Playground de traducción',
