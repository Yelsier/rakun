        ...
        <ContextMenu key={item._id}>
          <ContextMenuTrigger asChild>
            <Card
              ...
              className={cn(
                'relative contain-paint md:overflow-hidden cursor-pointer p-2 hover:bg-accent/40 data-[state=open]:bg-accent/60 data-[state=open]:ring-1 data-[state=open]:ring-primary/30 [content-visibility:auto] [contain-intrinsic-size:auto_11rem]',
