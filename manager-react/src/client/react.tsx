...
export type UseManagerSyncQueryArgs<TName extends ManagerQueryOperationName> = Omit<
  UseManagerQueryArgs<TName>,
  "refetchInterval"
> & {
  topic?: string;
  syncEnabled?: boolean;
...
> => {
  const client = useManagerClient();
  const query = createManagerQueryOptions(client, name, input, { consumeSignal });
